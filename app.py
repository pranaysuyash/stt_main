...
# # # from utils import allowed_file, get_file_category, extract_audio ##missing
...
# # #     # Create database tables and default roles if not exist
# # #     with app.app_context():
# # #         db.create_all()
# # #         for role in RoleEnum:
# # #             if not Role.query.filter_by(name=role).first():
# # #                 db.session.add(Role(name=role, description=f"{role.value.capitalize()} role"))
# # #         db.session.commit()
...
# # #             if media_type:
# # #                 query = query.filter(MediaFile.type.ilike(f'{media_type}%'))
...
# # #             ).group_by(func.to_char(MediaFile.uploaded_at, 'YYYY-MM-DD')).all()
...
# # #                 func.count(MediaFile.id).label('upload_count')
# # #             ).group_by(func.to_char(MediaFile.uploaded_at, 'YYYY'), func.to_char(MediaFile.uploaded_at, 'IW')).all()
...
# #                         # Add more metadata extraction if necessary
# #                     }
...
# #                         duration=None,  # Set duration if available
# #                         uploaded_at=datetime.utcnow(),
# #                         meta_data={},  # Add any extracted metadata here
# #                     )
...
# #     # **Removed db.create_all() and default role creation to let Alembic handle migrations**
# #     # 
# #     # Previously, the following block was present:
# #     # 
# #     # with app.app_context():
# #     #     db.create_all()
# #     #     for role in RoleEnum:
...
# #     #     db.session.commit()
# #     # 
# #     # This has been removed to prevent conflicts with Alembic migrations.
# #     # Ensure that default roles are created via migration scripts or separate seed scripts.
