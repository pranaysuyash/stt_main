...
//  * @returns {boolean}
//  */
// export const isAudioFile = (type) => type && type.startsWith('audio/');
...
//  * @returns {boolean}
//  */
// export const isVideoFile = (type) => type && type.startsWith('video/');
...
//  * @returns {boolean}
//  */
// export const isImageFile = (type) => type && type.startsWith('image/');
